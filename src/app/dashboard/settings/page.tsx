  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <p className="text-gray-600 mb-6">Personaliza tu experiencia con la aplicación.</p>
        
        {/* Pestañas */}
        <div className="border-b border-gray-200">
          <nav className="flex -mb-px space-x-8">
            <a href="#" className="border-b-2 border-indigo-500 py-4 px-1 text-sm font-medium text-indigo-600">
              Perfil
            </a>
        ...
        <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
          ...
          <div className="sm:col-span-6">
            ...
            <p className="mt-2 text-sm text-gray-500">Breve descripción para tu perfil.</p>
          </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Preferencias de notificación</h2>
        
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-md font-medium text-gray-900">Notificaciones por email</h3>
              <p className="text-sm text-gray-500">Recibe actualizaciones sobre tu cuenta por correo electrónico</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-md font-medium text-gray-900">Notificaciones push</h3>
              <p className="text-sm text-gray-500">Recibe alertas directamente en tu navegador</p>
            </div>
